...
/**
 * A partial event, emitted when the parser has received a partial message, but has not yet
 * received the terminating double newline. Determined by SINGLE newlines.
 *
 */
 ...
 * @public
 */
export type ParseEvent = ParsedEvent | ReconnectInterval | PartialEvent
